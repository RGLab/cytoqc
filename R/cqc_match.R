...
#' @param map For update, it is a named vector that provides the paired strings(i.e. old value vs new value).
...
#' match_result <- cqc_delete_match(match_result, "PTPRC PE", group_id = 5)
#' 
